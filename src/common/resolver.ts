...
> {
  ...
  constructor(name: ResolverName, inputSchema: Args, outputSchema: Result) {
    this.name = name;
...
export function resolver<ResolverName extends NarrowableString>(
  name: ResolverName,
) {
  return {
